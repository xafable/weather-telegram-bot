...
return [
    ...
    */
    'commands' => [
        \App\Services\TelegramCommands\StartCommand::class,
        \App\Services\TelegramCommands\SelectCityCommand::class,
        \App\Services\TelegramCommands\ChangeCityCommand::class,
        \App\Services\TelegramCommands\StoreCityCommand::class,
        \App\Services\TelegramCommands\GetTodayWeatherCommand::class,
        \App\Services\TelegramCommands\GetTomorrowWeatherCommand::class,
        \App\Services\TelegramCommands\GetAllWeatherCommand::class
    ],
